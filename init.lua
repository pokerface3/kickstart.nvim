...
--  See `:help 'clipboard'`
-- vim.o.clipboard = 'unnamedplus' #REVIEW
...
-- Enable telescope git_worktrees
...
-- Move page up/down with cursor in the middle of page
vim.keymap.set("n", "<C-d>", "<C-d>zz")
vim.keymap.set("n", "<C-u>", "<C-u>zz")

--# Search stays in the middle of page
...
vim.keymap.set("n", "<leader>lT", function()
    ...
    if #clients > 0 then
        ...
        vim.cmd("LspStart")
        print("All LSP servers started")
    end
end, { noremap = true, silent = true, desc = "Toggle all LSPs" })
